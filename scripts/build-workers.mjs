...
for (const w of WORKERS) {
	...
	const outPublic = resolve(root, w.outPublic || `public/${w.outName}`)
	const banner = {
		js: `/* generated by scripts/build-workers.mjs — do not edit by hand */`
	}
	const outputs = [outPublic]
	...
	const dest = outWorker
		? `worker/${w.name}/worker.bundle.js + public/${w.outName}`
		: w.outPublic
